"""
This module provides functionality for the pre-processing of the DARDAR and CloudSat
data.
"""
...
from pansat.products.satellite.cloudsat import l2c_ice, l2b_cldclass
...
def get_cldclass_cloud_mask(ds):
    ...
    mask = (ds.height.values < ds.surface_elevation.values[:, np.newaxis]) & (
        ds.height.values > -9999
    )
    cm[mask] = -1
    return cm
